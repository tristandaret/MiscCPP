...
int main()
{
	...
	std::cout << "Relative difference:          " << (scalefactorModel-scalefactorLUT)/scalefactorLUT*100 << "%" << std::endl;
	std::cout << "Reconstructed charge (LUT):   " << recochargeLUT << std::endl;
	std::cout << "Reconstructed charge (Model): " << recochargeModel << std::endl;
	std::cout << "Relative difference:          " << (recochargeModel-recochargeLUT)/recochargeLUT*100 << "%" << std::endl;

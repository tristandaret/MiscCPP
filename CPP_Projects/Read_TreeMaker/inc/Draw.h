...
class Draw
{
    public:
      ...
      // Setters
	  void SetOutputComparisonFolder(const std::string &outputComparisonFolder){foutputComparisonFolder = outputComparisonFolder;}
	...
	private:
		...
		TCanvas *fpCanvas;
		TLegend *fpLegend;
		std::vector<int> colors = {kRed+2, kBlue+2, kGreen+3, kOrange+7, kMagenta+2, kCyan+2, kYellow+2, kViolet+2};

...
int main(){
	...
	delete c1;
	delete fpStyle;
	for(auto hist : v_tdiffbottom) delete hist;
	for(auto hist : v_tdifftop) delete hist;
	for(auto hist : v_qdiffbottom) delete hist;
	for(auto hist : v_qdifftop) delete hist;

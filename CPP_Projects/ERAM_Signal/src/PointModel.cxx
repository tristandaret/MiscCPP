...
void DrawPointModel()
{
   ...
   // 	ph1f_currentmano->			Fill(i,
   // 1e3*(p_pointmodel->ptf1_Charge->Eval(i+1)-p_pointmodel->ptf1_Charge->Eval(i))); 	ph1f_dETFdtmano->			Fill(i,
   // p_pointmodel->ptf1_ETF->Eval(i+1)-p_pointmodel->ptf1_ETF->Eval(i)); 	ph1f_convorediv->			Fill(i,
   // p_pointmodel->ptf1_Signal3->Eval(i+1)-p_pointmodel->ptf1_Signal3->Eval(i));
   // }
   ...
   // ph1f_convomanoIETF->SetMinimum(1.1*std::min(ph1f_convomanoIETF->GetMinimum(),
   // ph1f_convomanoQdETFdt->GetMinimum()));
   // ph1f_convomanoIETF->SetMaximum(1.1*std::max(ph1f_convomanoIETF->GetMaximum(),
   // ph1f_convomanoQdETFdt->GetMaximum())); ph1f_convomanoIETF->Draw("hist"); ph1f_convorediv->Draw("hist same");

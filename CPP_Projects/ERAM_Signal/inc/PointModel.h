...
class PointModel
{
    ...
    void SetPadParam(float xpad, float ypad, float RC){fxpad = xpad; fypad = ypad; fRC = RC;}
    void SetChargeParam(float xcharge, float ycharge, float Qdrop){fxcharge = xcharge; fycharge = ycharge; fQdrop = Qdrop;}

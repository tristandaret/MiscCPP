...
class TrackModel
{
    ...
    void SetParameters(const double &length, const double &impact, const double &phi, const double &RC, const double &drift, const double &Dt);
    ...
    void ComputeAmplitudeLoss(const double &length, const double &impact, const double &phi, const double &RC, const double &drift, const double &Dt);
    ...
    void ComputeRealCharge( const double &ADCmax, const double &length, const double &impact, 

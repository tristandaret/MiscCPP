...
/////////////////////////////////////////////////////////////////////////////////////////// Start Tristan
                ...
                for (const auto& pair : moduleSubtracks) {
                    if (!pair.second.clusters.empty()) track.subtracks.push_back(pair.second);
        ...
        // Dump ////////////////////
        int nsubtrk = 0;
        for(const TrackT& track: eventT.tracks) nsubtrk += track.n_subtracks;
        ND280Log("  Subtracks: "                    << nsubtrk) ;
        int i_subtrk = 0 ;
        for(const TrackT& track: eventT.tracks){
            ND280Log(   "  Track parameters: X = "  << track.params[0] << " | Y = "  << track.params[1] << " | Z = "  << track.params[2] <<
                        " | Vx = "                  << track.params[3] << " | Vy = " << track.params[4] << " | Vz = " << track.params[5] <<

...
int main()
{
   ...
   std::string inputFolderPath =
      "~/Documents/Code/CPP/CPP_Projects/Read_TreeMaker/ROOT_files/" + type + "/" + run + "/" + comment;
   std::string inputFilePath = inputFolderPath + "/" + fileName + ".root";
   std::string outputROOTFolder =
      "~/Documents/Code/CPP/CPP_Projects/Read_TreeMaker/Output_ROOT/" + type + "/" + run + "/" + comment;
   std::string outputPDFFolder =
      "~/Documents/Code/CPP/CPP_Projects/Read_TreeMaker/Output_PDF/" + type + "/" + run + "/" + comment;
